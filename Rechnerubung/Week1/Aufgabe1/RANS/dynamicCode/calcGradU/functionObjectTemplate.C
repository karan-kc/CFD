...
//{{{ begin code
    #line 62 "/home/ensm_student/Downloads/RANS/system/controlDict.functions.calcGradU"
...
//{{{ begin code
    #line 85 "/home/ensm_student/Downloads/RANS/system/controlDict.functions.calcGradU"
const volVectorField& U = mesh().lookupObjectRef<volVectorField>("U");
